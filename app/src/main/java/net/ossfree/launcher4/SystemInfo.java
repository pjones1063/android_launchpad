...
public class SystemInfo {
    ...
    public String getCityLocation () {
        try {
            ...
            return  context.getString(R.string.sys_loc) +" "+
                    addresses.get(0).getLocality() +" "+
                    addresses.get(0).getAdminArea();

        } catch (Exception e) {
            LLg.e(e.getLocalizedMessage());
            return context.getString(R.string.sys_noloc);
        }
    }
    ...
    public String getSDPath () {
        return MainActivity.getSDPath();
    }

    public String getSDTotal() {
        return context.getString(R.string.sys_sdcard) + getGigTotal(new File(getSDPath()));
    }

    public String getSDFree() {
        return getGigFree(new File(getSDPath()));
    }

    public String getSDPrcnt() {
        return getFreePrcnt(new File(getSDPath()));
    }
    ...
    public String getITTotal() {
        return context.getString(R.string.sys_internalcard)  + getGigTotal(new File(getITPath()));
    }

    public String getITFree() {
        return getGigFree(new File(getITPath()));
    }

    public String getITPrcnt() {
        return getFreePrcnt(new File(getITPath()));
    }

    public Bitmap getSDSpaceWPB() {
        return getBitmapDown(getFreeDecimal(new File(getSDPath())));
    }

    public Bitmap getITSpaceWPB() {
         return getBitmapDown(getFreeDecimal(new File(getITPath())));
    }
    ...
    public  String  getGigFree(File f) {
        try {
            ...
            Toast.makeText(context.getApplicationContext(), "Unable to stat mount point \n" +e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            LLg.e(e.getMessage());
            return " 0.0 GB ";
        }
    }
