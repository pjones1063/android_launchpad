...
public class DocAdapter extends ArrayAdapter<DocInfo>  {

	private  List<DocInfo> allList = null;;	
	private LayoutInflater layoutInflater = null;
	int rowid = 0;
		
	public DocAdapter(Context context, int textViewResourceId, List<DocInfo> docs) {
		super(context, textViewResourceId, textViewResourceId, docs);
		rowid = textViewResourceId;
		allList = new ArrayList<DocInfo>(docs);
