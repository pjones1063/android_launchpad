...
public class AppsWindowAdapter extends ArrayAdapter <ItemInfo>  {

	private  List<ItemInfo> filterList = null;
	private  List<ItemInfo> allList = null;;
	private TabPage tabPage;
	private FolderFilter filter = null;	
	...
	public AppsWindowAdapter(Context context, int textViewResourceId, TabPage tabPageID) {
